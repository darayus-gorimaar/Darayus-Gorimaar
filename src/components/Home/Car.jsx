...
export function Car(props) {
  const { nodes, materials } = useGLTF(
    "./models/ferrari_f40__www.vecarz.com.glb"
  );
  const ref = useRef();
  const tl = useRef();
  ...
  useLayoutEffect(() => {
    ...
    // Move the car down with a delay
    tl.current.to(
      ref.current.position,
      {
        y: 2,
    ...
    // Tilt the car down towards the camera
    tl.current.to(
      ref.current.rotation,
      {
        x: 0.5,
  ...
  return (
    <group {...props} dispose={null} ref={ref}>
      ...
      <mesh
        ...
        material={materials["Rim_-_Black_part"]}
        position={[0, 0.007, -0.049]}
        rotation={[-Math.PI / 2, 0, 0]}
      />
      <mesh
        geometry={nodes.Object_28.geometry}
        material={materials["Metal_-_Black"]}
        position={[0, 0.007, -0.049]}
        rotation={[-Math.PI / 2, 0, 0]}
      />
      <mesh
      ...
      <mesh
        ...
        material={materials["Plastic_-_Glossy_Black"]}
        position={[0, 0.007, -0.049]}
        rotation={[-Math.PI / 2, 0, 0]}
      />
      <mesh
      ...
      <mesh
        ...
        material={materials["Fabric_-_Red"]}
        position={[0, 0.007, -0.049]}
        rotation={[-Math.PI / 2, 0, 0]}
      />
      <mesh
      ...
      <mesh
        ...
        material={materials["Metal_-_Grey"]}
        position={[0, 0.007, -0.049]}
        rotation={[-Math.PI / 2, 0, 0]}
      />
      <mesh
...
useGLTF.preload("./models/ferrari_f40__www.vecarz.com.glb");
